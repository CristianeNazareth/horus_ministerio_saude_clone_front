...
export const TextLogin = () => (
    ...
    <form action="">
        ...
        <span className='span_content'>
            ...
            <a className="link_emphasis" href="solicitacaoUsuario.do?acao=gravarNovaSolicitacao">Cadastro de Novo Usuário&nbsp;</a>
            e aguardar a autorização do Gestor.
        </span>
        <br />
        <span className='emphasis'>Atenção!&nbsp;</span>
        <span className='span_content'>Caso o Teclado Virtual para informar a senha não apareça, verifique se o browser está configurado para ter suporte ao Java ou baixe o software Java no seguinte endereço:&nbsp;
